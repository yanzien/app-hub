...
const GITHUB_REPOS = [
  { name:'home（速来查看，同款可私信）', full:'yanzien/home', desc:'🏠 个人主页 · Young 的个人主页，展示基本信息、项目链接与社交账号。简洁现代、响应式、支持深色模式。', url:'https://yanzien.github.io/home', icon:'🏠', featured:true, tags:['个人主页', '响应式', 'Pages'], tech:'HTML/CSS/JS', status:'已部署', upd:'持续更新' },
